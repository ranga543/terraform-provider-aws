...
func Provider() terraform.ResourceProvider {
	...
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"aws_ec2_client_vpn_authorize_ingress":                    resourceAwsEc2ClientVpnAuthorizeIngress(),
			"aws_ec2_client_vpn_apply_security_groups":                resourceAwsEc2ClientVpnApplySecurityGroups(),
